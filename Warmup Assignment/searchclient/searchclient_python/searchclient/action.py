...
class Action(Enum):
    ...
    PullN = ("Pull(N,N)", ActionType.Pull, -1, 0, -1, 0)
    PullS = ("Pull(S,S)", ActionType.Pull, 1, 0, 1, 0)
    PullE = ("Pull(E,E)", ActionType.Pull, 0, 1, 0, 1)
    PullW = ("Pull(W,W)", ActionType.Pull, 0, -1, 0, -1)
